...
const DispositorHome = () => {
  ...
  const cols = [
    ...
    { name: t("Reports.Kind"), property: (x: Readonly<AccidentReportResponse>) => <Enum enum={EmergencyType} value={x.emergencyType} />, filterBy: "emergencyType", sortBy: "emergencyType" },
    { name: t("Reports.Date"), property: (x: Readonly<AccidentReportResponse>) => <DateDisplay value={x.date} />, sortBy: "date", filterBy: "date" },
    { name: t("Reports.AmountVictims"), property: "victimCount", filterBy: "victimCount", sortBy: "victimCount" }
  ];
    ...
    <Container className="mt-5">
      ...
      <Row xs={3} className="justify-content-around">
        <ProgressChart width={350} height={350} value={ambulances.all !== 0 ? (ambulances.available / ambulances.all) * 100 : 0} innerRadius="100" label tooltip color={{
          ...
          g: 162,
          b: 0
        }} full={t("Ambulance.Avail")} empty={t("Ambulance.Unavail")} />
        ...
        <ProgressChart width={350} height={350} value={79} innerRadius="100" label tooltip color={{
          ...
          g: 146,
          b: 255
        }} full={t("Reports.Accep")} empty={t("Reports.Pending")} />
      </Row>
      ...
      <h2 className="text-center">{t("Reports.Reports")}</h2>
      <Row className="my-3">
