  ...
  return (
    <Form onSubmit={onSubmit}>
      ...
      <Row md={2}>
        ...
        <FormControl id="phoneNumber" required onChange={(e) => setPhoneNumber(e.target.value)} className="mb-3" value={phoneNumber} label="Numer telefonu" type="text" disabled={!props.allowEdit} />
      </Row>
      ...
      <Button type={props.allowEdit ? "submit" : "button"} onClick={() => props.allowEdit ? null : navigate("edit")}>{props.allowEdit ? "Zapisz" : "Edtuj"}</Button>
    </Form>
  );
};
